...
<table align="center">
     <tr>
         ...
         <td><font color="D0104C"><a href="http://47.94.0.189/phpmyadmin">后台数据库管理</a></font></td>
     </tr>
</table>
<table width="620" border="0" align="center" cellpadding="0" cellspacing="1">
     <tr bgcolor="D0104C">
         ...
         <td width="100"><font color="#FFFFFF" align="center">操作1</font></td>
         <td width="100"><font color="#FFFFFF" align="center">操作2</font></td>
     </tr>
<?php
	...
	for($i=0;$i<$number;$i++){
		...
		if($i>=$p && $i < $check){
			if($i%2 ==0)
			  ...
			  echo"<tr>";
			  echo"<td width='80' align='center'><a href='CourseDetail.php? Cou-No=".$row['CouNo']."'>".$row['CouNo']."</a></td>";
